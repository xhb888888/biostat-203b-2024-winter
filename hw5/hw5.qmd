...
```{r}
# Random grip search which will use half of time as above 
...
(logit_fit <- logit_wf |>
  tune_bayes(
    ...
    control = control_bayes(verbose = TRUE, save_pred = FALSE)
    )) |>
  system.time()
```

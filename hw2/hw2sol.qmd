...
```{r}
system.time(df2 <- read_csv("~/mimic/hosp/admissions.csv.gz",col_types='icTTTccccccccTTi'))
pryr::object_size(df2)
```
...
```{r}
df <- read_csv("~/mimic/hosp/labevents.csv.gz",col_select=c('subject_id', 'itemid', 'charttime', 'valuenum'))
```

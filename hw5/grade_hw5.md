...
### Reproducibility: 45/50

`readRDS("./mimic_icu_cohort.rds")` does not work since the file is not in hw5 folder. `-5.0`
...
-   Showing the distribution of the outcome is great!

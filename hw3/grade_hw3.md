...
- Q3 (23/25)    
    ...
    - Q3.2 (18/20) Student must explain patterns in admission hour, admission minute, and length of hospital display. Just describing the pattern is not enough. There are no wrong or correct explanations; any explanation suffices. 
      ...
      Need to mention unusual observations with negative length of stay. If you have not noticed, you need to conclude that there is nothing unusual. It is usual that the distribution is right skewed, although outliers might be unusual `-2.0`

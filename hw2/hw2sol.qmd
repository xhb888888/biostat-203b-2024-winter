...
**Answer:**
'fread' is the fastest. The default parsed data types are different. The resultant dataframe uses 1.2GB memory, the resultant tibble uses 1.1GB memory, and the resultant data.table uses 1.2GB memory.
